...
const [dataMovie, setDataMovie] = useState(data);       /* => movie liste  donner les valeurs data */
...
/* l'ajout du movie  (lorsque on ajoute du nouvel movie on va ecrase le'acien et remplacer par le nouveaux)*/74
